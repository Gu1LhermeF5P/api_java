...
Este repositório contém a API RESTful desenvolvida em Java com Spring Boot, que serve como backend para a aplicação mobile **[MotoScan]([https://github.com/SeuUsuario/motoscan-mobile](https://github.com/Gu1LhermeF5P/MottoScan))**. *(<-- Troque pelo link do seu repositório do frontend)*
